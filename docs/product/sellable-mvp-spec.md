...
- **Google Calendar: IN_PROGRESS.** OAuth, listado y asignación live pasaron con owner sintético el 2026-09-15; la disponibilidad y el núcleo de ofertas y holds están técnicamente `DONE` con validación sintética y CI. Faltan FreeBusy live, eventos, selección pública, confirmación y booking extremo a extremo; no se ha ejecutado una prueba live de ofertas.
