...
| Google Calendar y booking | `IN_PROGRESS` | Contrato OAuth y asignación de calendarios por artista en implementación; no incluye todavía `freeBusy`, eventos, ofertas ni booking y falta evidencia live con Google. |
