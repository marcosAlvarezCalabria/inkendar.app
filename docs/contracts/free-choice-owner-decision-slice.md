...
La notificación al cliente posterior a un rechazo no forma parte de esta decisión de dominio. Una [extensión independiente del outbox](./free-choice-rejection-notification-slice.md), revisada en el PR #43 con CI verde y todavía sin merge ni prueba live, observa la transición durable sin cambiar su idempotencia, la liberación del hold ni la ausencia de llamadas a Google.
