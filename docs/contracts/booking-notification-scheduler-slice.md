...
Este slice original no incluyó rechazos. Elección de un SaaS de email, UI de configuración, recordatorios, Facebook live, endpoint público, proveedor de cron, cola dedicada y prueba live de notificaciones permanecen fuera. La extensión posterior de rechazo free-choice quedó integrada mediante el PR #43 con CI post-merge verde, pero aún no se ha probado live; la capacidad global de booking permanece `IN_PROGRESS` hasta ese gate.
